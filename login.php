...
if ($_POST) {
    ...
    if ($result->num_rows==1) {
        ...
        $error='<label for="promter" class="form-label" style="color:red;text-align:center;">We can’t find any account for this email.</label>';
    }
}
?>
<!DOCTYPE html>
...
<div class="container">
    <table border="0" style="margin: 0;padding: 0;width: 60%;">
        ...
        <tr><td><br><label for="" class="sub-text">Don't have an account? </label><a href="signup.php" class="hover-link1 non-style-link">Sign Up</a><br><br><br></td></tr>
        </form>
    </table>
</div>
</center>
